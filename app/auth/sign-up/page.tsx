      ...
      <div className="hidden lg:flex flex-1 bg-card items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center p-12">
          <h2 className="text-4xl font-bold mb-4">
            <span className="text-foreground">JUNTE-SE A</span>
            <br />
            <span className="neon-glow text-primary">FAMILIA</span>
          </h2>
          <p className="text-muted-foreground max-w-sm mx-auto">
            Crie sua conta e faca parte do time mais estiloso da cidade.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Cadastre-se para agendar horarios e acompanhar seu historico.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="w-full h-12 neon-border" disabled={loading}>
              {loading ? (
                <>
