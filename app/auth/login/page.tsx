        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Entre na sua conta para agendar horarios e acompanhar seus cortes.
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-card items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center p-12">
          <h2 className="text-4xl font-bold mb-4">
            <span className="neon-glow text-primary">ESTILO</span>
            <br />
            <span className="text-foreground">COMEÇA AQUI</span>
          </h2>
          <p className="text-muted-foreground max-w-sm mx-auto">
            Agende seu proximo corte em segundos e garanta o melhor atendimento.
          </p>
        </div>
      </div>
    </div>
